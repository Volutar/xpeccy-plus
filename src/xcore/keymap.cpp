...
static xShortcut short_tab[] = {
	...
	{SCG_MAIN, XCUT_SPEED_UP, "key.speed.up", "Speed up", QKeySequence(), QKeySequence(Qt::ALT | Qt::KeypadModifier | Qt::Key_Plus)},
	{SCG_MAIN, XCUT_SPEED_DOWN, "key.speed.down", "Speed down", QKeySequence(), QKeySequence(Qt::ALT | Qt::KeypadModifier | Qt::Key_Minus)},
